...
<html lang="en">
    ...
    <div class="col-md-10 minHeight">
      ...
      <div class="container">
        <h2 class="d-flex justify-content-center">Configuracion de Parametros</h2>
        <br>
        <br>
        <div class="row">
          <div class="col-md-10 offset-md-1">
            <nav>
              <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <a class="nav-item nav-link active" id="nav-function-tab" data-toggle="tab" href="#nav-function" role="tab" aria-controls="nav-function" aria-selected="true">Formula</a>
            ...
            <div class="tab-content" id="nav-tabContent">
              ...
              <div class="tab-pane fade" id="nav-variables" role="tabpanel" aria-labelledby="nav-variables-tab">
                <div class="row">
                  <div class="col-md-10 offset-md-1">
                    <button class="btn btn-outline-primary" type="button" data-toggle="modal" data-target="#create-variables">
                      Crear Variables
                    </button>  
                    <hr>
                    <table class="table table-borderless">
    ...
    <div class="modal fade" id="modify-function" tabindex="-1" role="form" aria-labelledby="Modificar-Formula" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="modifyFunction">Editar Formula</h5>
          ...
          <div class="modal-footer">
            <button type="button" name="modify-function-button" id="modify_function_button" class="btn btn-primary btn-lg">
              Modificar
            </button>
          </div>
        </div>
